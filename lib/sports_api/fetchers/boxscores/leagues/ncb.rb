class SportsApi::Fetcher::Boxscore::NCB < SportsApi::Fetcher::Boxscore
  ...
  def score_fetcher
    @score_fetcher ||= SportsApi::Fetcher::Score::NCB.find(event_date)
  end

  def markup
    @markup ||= get('ncb/game', gameId: gameid)
  end
end
