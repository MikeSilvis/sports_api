...
describe SportsApi::Fetcher::Score::NCB do
  describe '#find' do
    describe 'postgame' do
      ...
      before { expect_any_instance_of(SportsApi::Fetcher::Score::NCB).to receive(:get).with('basketball', 'mens-college-basketball', dates: 20150407, limit: 200, groups: 100).and_return(json_stub) }
    ...
    describe 'pregame' do
      ...
      before { expect_any_instance_of(SportsApi::Fetcher::Score::NCB).to receive(:get).with('basketball', 'mens-college-basketball', dates: 20151113, limit: 200, groups: 100).and_return(json_stub) }
      context 'event info' do
